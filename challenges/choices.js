...
function choicesHandler() {
  ...
  const userOption = prompt("enter desirable option");

  // execute core logic
  result = choices(userText, userOption);
  ...
  console.log("\n-- choices --");
  // user inputs
  console.log("userInput:", "(" + typeof userText + "),", userText);
  console.log("userInput:", "(" + typeof userOption + "),", userOption);
  // result
...
document
  .getElementById("choices-button")
  .addEventListener("click", choicesHandler);
